...
Route::get('/homepage/profile', [App\Http\Controllers\Api\ProfileController::class, 'ProfileHomePage']);

// student
Route::get('/student', [App\Http\Controllers\Api\StudentController::class, 'index']);
Route::get('/homepage/student', [App\Http\Controllers\Api\StudentController::class, 'StudentHomePage']);

// teacher
Route::get('/teacher', [App\Http\Controllers\Api\TeacherController::class, 'index']);
Route::get('/homepage/teacher', [App\Http\Controllers\Api\TeacherController::class, 'TeacherHomePage']);

// subject
Route::get('/subject', [App\Http\Controllers\Api\SubjectController::class, 'index']);
Route::get('/homepage/subject', [App\Http\Controllers\Api\SubjectController::class, 'SubjectHomePage']);