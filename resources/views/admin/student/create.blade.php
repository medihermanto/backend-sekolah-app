                                        ...
                                        <div class="col-12 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name"
                                                    ...
                                                    placeholder="type your category name" value="{{ old('name') }}"
                                                    required>
                                                @error('name')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="email"
                                                    ...
                                                    value="{{ old('email') }}" placeholder="Type email here.. " required>
                                                @error('email')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="phone"
                                                    ...
                                                    value="{{ old('phone') }}" placeholder="type phone number here.."
                                                    required>
                                                @error('phone')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
