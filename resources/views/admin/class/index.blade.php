                                ...
                                <div class="row">
                                    @can('classes.create')
                                        <div class="col-6 col-sm-6 col-lg-6">
                                            <a href="{{ route('admin.class.create') }}" class="btn btn-primary"> <i
                                        ...
                                        @foreach ($classes as $no => $class)
                                            <tr>
                                                <td style="text-align:center">
                                                    {{ ++$no + ($classes->currentPage() - 1) * $classes->perPage() }}
                                                </td>
                                                <td>{{ $class->name }}</td>
                                                <td>{{ $class->teacher->name ?? 'No Data' }}</td>
                                                <td class="text-center">
                                                    ...
                                                    @can('classes.delete')
                                                        <button onClick="Delete(this.id)" class="btn btn-sm  btn-danger"
                                                            id="{{ $class->id }}"><i class="fas fa-trash"></i></button>
                                                    @endcan
                                                </td>
                                            </tr>
                                        @endforeach
