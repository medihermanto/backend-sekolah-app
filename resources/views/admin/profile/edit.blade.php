            ...
            <div class="section-body">
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12">
                        <form action="{{ route('admin.profile.update', $profiles->id) }}" method="post"
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-6 col-lg-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control content @error('opening_speech') is-invalid @enderror" name="opening_speech"
                                                    placeholder="Type the opening_speech post here" rows="25">{!! old('opening_speech', $profiles->opening_speech) !!}</textarea>
                                        ...
                                        <div class="col-6 col-lg-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control content @error('visi') is-invalid @enderror" name="visi"
                                                    placeholder="Type the visi post here" rows="25">{!! old('visi', $profiles->visi) !!}</textarea>
                                                @error('visi')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-6 col-lg-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control content @error('misi') is-invalid @enderror" name="misi"
                                                    placeholder="Type the misi here" rows="25">{!! old('misi', $profiles->misi) !!}</textarea>
                                                @error('misi')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-6 col-lg-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control content @error('profile') is-invalid @enderror" name="profile"
                                                    placeholder="Type the profile here" rows="25">{!! old('profile', $profiles->profile) !!}</textarea>
                                                @error('profile')
                                                    <div class="invalid-feedback" style="display: block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-6 col-lg-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control content @error('struktur_organisasi') is-invalid @enderror" name="struktur_organisasi"
                                                    placeholder="Type the organization structure here" rows="25">{!! old('struktur_organisasi', $profiles->struktur_organisasi) !!}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control content @error('informasi_pendaftaran') is-invalid @enderror" name="informasi_pendaftaran"
                                            placeholder="Type the register information here" rows="25">{!! old('informasi_pendaftaran', $profiles->informasi_pendaftaran) !!}</textarea>
